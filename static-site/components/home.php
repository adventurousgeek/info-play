    ...
    <div class="modal-dialog">
        ...
        <div class="container">
            <div class="content-block">
                <div class="row">
                    <div class="col-md-4">
                        <h1>We are seeking blockchain/crypto developers, as well as machine learning expertise.</h1>
                        <p>Schedule an interview. Work with us to claim bonus coins of your choice.</p>
                        <p>Drop your resume at <a href="" class="text-white">carrers@infoplay.ai</a></p>
                    </div>
                    <div class="col-md-8">
                        <form action="">
